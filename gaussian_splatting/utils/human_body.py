...
from submodules.smplx.smplx import SMPLLayer
from submodules.smplx.smplx.utils import SMPLOutput
from submodules.smplx.smplx.lbs import vertices2joints, batch_rigid_transform
...
class SMPLTemplate(nn.Module):
    ...
    def forward(self, masked_theta=None, xyz_canonical=None, instances_mask=None):
        ...
        if masked_theta is None:
            ...
            ), "pose should have shape Bx24x4, in axis-angle format"
            nB = len(masked_theta)
